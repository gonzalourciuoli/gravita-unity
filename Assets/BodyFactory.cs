...
public class BodyFactory: MonoBehaviour
{
    public static GameObject CreateBody(string bodyName, string bodyData)
    {
        ...
        if (bodyPrefab != null)
        {
            ...
            float bodyEquatorialRadius = planetInfo.equa_radius / 10000;
            float bodyPolarRadius = planetInfo.polar_radius / 10000;
            planetComponent.transform.localScale = new Vector3(bodyEquatorialRadius, bodyPolarRadius, bodyEquatorialRadius);
